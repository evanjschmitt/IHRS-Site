    ...
    $("#sanctuary").append(`<div class="profile">
      ...
      <div class="right">
        ...
        <div class="bioButton" id="bioButton">
          <a href="#san${i}" id="bioButton"><span>View My Bio!</span></a>
        </div>
      </div>
    </div>`);
  }
...
//This was my attempt at the dynamic page functions, I left it here with the hopes of my errors being found//
